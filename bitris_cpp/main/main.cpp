...
void test(const size_t height, const std::array<Data, N> &result, const Shape shape, size_t expected) {
    ...
    if (popcount<Data>(result) == expected) {
        ...
        std::cout << name << ": NG" << std::endl;
        std::cout << to_string(result, height) << std::endl;
