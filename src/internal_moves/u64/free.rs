...
pub fn to_free_space(free_space_block: FreeSpace64, piece: Piece) -> FreeSpace64 {
    match piece.shape {
        Shape::T => match piece.orientation {
        ...
        Shape::I => match piece.orientation {
        ...
        Shape::O => match piece.orientation {
        ...
        Shape::L => match piece.orientation {
        ...
        Shape::J => match piece.orientation {
        ...
        Shape::S => match piece.orientation {
        ...
        Shape::Z => match piece.orientation {
