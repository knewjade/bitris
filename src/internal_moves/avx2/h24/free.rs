...
#[inline(always)]
pub fn to_free_space(free_space_block: FreeSpaceSimd24, piece: Piece) -> FreeSpaceSimd24 {
    match piece.shape {
        Shape::T => {
...
#[inline(always)]
pub fn t_north(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
...
#[inline(always)]
pub fn t_east(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
...
#[inline(always)]
pub fn t_south(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
...
#[inline(always)]
pub fn t_west(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
...
#[inline(always)]
pub fn i_north(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<0, 1, 0, 0>()
        .and(space.clone())
        .and(space.clone().shift::<1, 0, 0, 0>())
...
#[inline(always)]
pub fn i_east(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<0, 0, 1, 0>()
        .and(space.clone())
        .and(space.clone().shift::<0, 0, 0, 1>())
...
#[inline(always)]
pub fn i_south(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<1, 0, 0, 0>()
        .and(space.clone())
        .and(space.clone().shift::<0, 1, 0, 0>())
...
#[inline(always)]
pub fn i_west(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<0, 0, 0, 1>()
        .and(space.clone())
        .and(space.clone().shift::<0, 0, 1, 0>())
...
#[inline(always)]
pub fn o_north(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone()
        .and(space.clone().shift::<1, 0, 0, 0>())
        .and(space.clone().shift::<0, 0, 1, 0>())
...
#[inline(always)]
pub fn o_east(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone()
        .and(space.clone().shift::<0, 0, 0, 1>())
        .and(space.clone().shift::<1, 0, 0, 0>())
...
#[inline(always)]
pub fn o_south(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone()
        .and(space.clone().shift::<0, 1, 0, 0>())
        .and(space.clone().shift::<0, 0, 0, 1>())
...
#[inline(always)]
pub fn o_west(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone()
        .and(space.clone().shift::<0, 0, 1, 0>())
        .and(space.clone().shift::<0, 1, 0, 0>())
...
#[inline(always)]
pub fn l_north(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<0, 1, 0, 0>()
        .and(space.clone())
        .and(space.clone().shift::<1, 0, 0, 0>())
        .and(space.shift::<1, 0, 1, 0>())
...
#[inline(always)]
pub fn l_east(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<0, 0, 1, 0>()
        .and(space.clone())
        .and(space.clone().shift::<0, 0, 0, 1>())
        .and(space.shift::<1, 0, 0, 1>())
...
#[inline(always)]
pub fn l_south(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<1, 0, 0, 0>()
        .and(space.clone())
        .and(space.clone().shift::<0, 1, 0, 0>())
        .and(space.shift::<0, 1, 0, 1>())
...
#[inline(always)]
pub fn l_west(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<0, 0, 0, 1>()
        .and(space.clone())
        .and(space.clone().shift::<0, 0, 1, 0>())
        .and(space.shift::<0, 1, 1, 0>())
...
#[inline(always)]
pub fn j_north(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
...
#[inline(always)]
pub fn j_east(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
...
#[inline(always)]
pub fn j_south(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
...
#[inline(always)]
pub fn j_west(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
...
#[inline(always)]
pub fn s_north(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<0, 1, 0, 0>()
        .and(space.clone())
        .and(space.clone().shift::<0, 0, 1, 0>())
        .and(space.shift::<1, 0, 1, 0>())
...
#[inline(always)]
pub fn s_east(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<0, 0, 1, 0>()
        .and(space.clone())
        .and(space.clone().shift::<1, 0, 0, 0>())
        .and(space.shift::<1, 0, 0, 1>())
...
#[inline(always)]
pub fn s_south(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<1, 0, 0, 0>()
        .and(space.clone())
        .and(space.clone().shift::<0, 0, 0, 1>())
        .and(space.shift::<0, 1, 0, 1>())
...
#[inline(always)]
pub fn s_west(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<0, 0, 0, 1>()
        .and(space.clone())
        .and(space.clone().shift::<0, 1, 0, 0>())
        .and(space.shift::<0, 1, 1, 0>())
...
#[inline(always)]
pub fn z_north(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<0, 1, 1, 0>()
        .and(space.clone().shift::<0, 0, 1, 0>())
        .and(space.clone())
        .and(space.shift::<1, 0, 0, 0>())
...
#[inline(always)]
pub fn z_east(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<1, 0, 1, 0>()
        .and(space.clone().shift::<1, 0, 0, 0>())
        .and(space.clone())
        .and(space.shift::<0, 0, 0, 1>())
...
#[inline(always)]
pub fn z_south(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<1, 0, 0, 1>()
        .and(space.clone().shift::<0, 0, 0, 1>())
        .and(space.clone())
        .and(space.shift::<0, 1, 0, 0>())
...
#[inline(always)]
pub fn z_west(space: FreeSpaceSimd24) -> FreeSpaceSimd24 {
    space.clone().shift::<0, 1, 0, 1>()
        .and(space.clone().shift::<0, 1, 0, 0>())
        .and(space.clone())
        .and(space.shift::<0, 0, 1, 0>())
